...
//   const popupCardAdd = new Popup(document.querySelector(".popup"), document.querySelector(".popup__close"), document.querySelector(".user-info__button"));
//   const popupEditProfile = new Popup(document.querySelector(".popup_edit-profile"), document.querySelector(".popup__close_edit-profile"), document.querySelector(".profile__button"));
//   const popupEditAvatar = new Popup(document.querySelector("#avatarEditPopup"), document.querySelector("#avatarPopupClose"), document.querySelector(".user-info__photo"));
...
//   const userInfo = new UserInfo(document.querySelector(".user-info__name"), document.querySelector(".user-info__job"),document.querySelector(".user-info__photo"), mestoFetchApi );
